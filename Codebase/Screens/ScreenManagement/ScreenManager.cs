...
namespace GGJ_DisasterMode.Codebase.Screens
{
    ...
    public class ScreenManager : DrawableGameComponent
    {
        ...
        /// <summary>
        /// A default Song shared by all the screens. This saves
        /// each screen having to bother creating their own local instance
        /// and needn't load stuff the loading song.
        /// </summary>
        public Song LoadingSong
        {
            get { return loadingSong; }
        }
        ...
        {
            GameScreen[] screens = this.screens.ToArray();
            foreach (GameScreen screen in screens)
            {

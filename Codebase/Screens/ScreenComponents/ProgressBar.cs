...
namespace GGJ_DisasterMode.Codebase.Screens
{
    ...
    public class ProgressBar
    {
        ...
        public Color borderColorOuter
        {
            ...
            set
            {
                if (m_borderColorOuter != value)
                {
                    ...
                    outerTexture = new Texture2D(graphics, 1, 1);
        ...
        public Color borderColorInner
        {
            ...
            set
            {
                if (m_borderColorInner != value)
                {
                    ...
                    innerTexture = new Texture2D(graphics, 1, 1);
        ...
        public Color fillColor
        {
            ...
            set
            {
                if (m_fillColor != value)
                {
                    ...
                    fillTexture.Dispose();
                    fillTexture = new Texture2D(graphics, 1, 1);
        ...
        public ProgressBar(Rectangle rect, Orientation orientation)
        {
            m_borderOuterRect = rect;
        ...
        public ProgressBar(GraphicsDevice graphics, Int32 x, Int32 y, Int32 width, Int32 height)
        {
        ...
        /// <param name="height">Height of the progress bar.</param>
        /// /// <param name="orientation">The orientation of the progress bar.</param>
        public ProgressBar(Int32 x, Int32 y, Int32 width, Int32 height, Orientation orientation)
        {
            m_borderOuterRect = new Rectangle(x, y, width, height);
            m_orientation = orientation;
